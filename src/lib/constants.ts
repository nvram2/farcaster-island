 ...
 */
export const APP_NAME: string = 'Farcaster Island';

/**
 * A brief description of the mini app's functionality.
 * Used in app store listings and metadata.
 */
export const APP_DESCRIPTION: string = ' a digital paradise built on Farcaster 🌊 Here, founders, creators, and builders dock their ships to find their tribe not through follower counts, but through vibes, plays, and collabs';
 ...
 */
export const APP_BUTTON_TEXT: string = 'Enter FC Island';
